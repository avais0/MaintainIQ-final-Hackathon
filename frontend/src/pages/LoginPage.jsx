...
import { KeyRound, Mail, AlertCircle, Wrench, ShieldAlert, User } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-radial from-slate-900 to-slate-950 p-4">
      ...
      <div className="w-full max-w-md glass-panel rounded-2xl p-8 glow-indigo animate-fade-in relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">{isRegistering ? 'Create a New Account' : 'Asset Management & Service Portal'}</p>
        </div>
        ...
        <div className="text-center mt-5">
          ...
          >
            {isRegistering ? 'Already have an account? Sign In' : "New to MaintainIQ? Create an Account"}
          </button>
        </div>
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 border border-slate-200 border-slate-800 hover:border-emerald-500/40 bg-slate-900/30 hover:bg-slate-900/60 text-slate-300 hover:text-white rounded-xl py-2.5 text-sm transition-all cursor-pointer font-bold"
              >
